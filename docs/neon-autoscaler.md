...
kubectl -n kube-system \
  ...
  autoscale-scheduler=docker.io/simplyblock/autoscaling:autoscale-scheduler-main-707a485
...
kubectl -n kube-system \
  ...
  autoscaler-agent=docker.io/simplyblock/autoscaling:autoscaler-agent-main-707a485
...
kubectl -n neonvm-system \
  ...
  vxlan-controller=docker.io/simplyblock/autoscaling:neonvm-vxlan-controller-main-707a485
kubectl -n neonvm-system rollout status daemonset/neonvm-vxlan-controller

kubectl -n neonvm-system \
  set image deployment/neonvm-controller \
  manager=docker.io/simplyblock/autoscaling:neonvm-controller-main-707a485
