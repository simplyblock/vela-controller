...
- Extend
  ...
  - [x] `vela-controller/src/api/system.py:73` resource-limit definitions should be extended to be backend-capability aware (especially iops visibility/validation paths).
