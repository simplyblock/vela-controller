...
_VM_STATUS_TO_BRANCH_STATUS: Final[dict[StatusType, BranchServiceStatus]] = {
    ...
    "Migrating": "UPDATING",
    "Unknown": "UNKNOWN",
    "ErrorUnschedulable": "ACTIVE_UNHEALTHY",
    "ErrImagePull": "ACTIVE_UNHEALTHY",
    "ImagePullBackOff": "ACTIVE_UNHEALTHY",
    "ErrorPvcNotFound": "ACTIVE_UNHEALTHY",
    "DataVolumeError": "ACTIVE_UNHEALTHY",
