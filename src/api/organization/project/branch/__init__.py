...
from ....._util import DEFAULT_DB_NAME, DEFAULT_DB_USER, Identifier, bytes_to_gib_quantity
...
async def _apply_resize_operations(
    ...
    if "database_size" in effective_parameters:
        ...
        storage_size_gi = bytes_to_gib_quantity(new_database_size)
        await kube_service.resize_pvc_storage(namespace, pvc_name, storage_size_gi)
    ...
    if "storage_size" in effective_parameters:
        ...
        storage_size_gi = bytes_to_gib_quantity(new_storage_size)
        await kube_service.resize_pvc_storage(namespace, pvc_name, storage_size_gi)
