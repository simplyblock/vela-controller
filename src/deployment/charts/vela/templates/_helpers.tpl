...
{{/*
Return the in-cluster hostname for the database service.
*/}}
{{- define "vela.db.serviceHostname" -}}
{{- printf "%s.%s.svc.cluster.local" (include "vela.db.fullname" .) .Release.Namespace -}}
{{- end }}
